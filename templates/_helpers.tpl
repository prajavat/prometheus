...
{{- define "prometheus.sensorExporter.labels" -}}
{{ include "prometheus.sensorExporter.matchLabels" . }}
{{ include "prometheus.common.metaLabels" . }}
{{- end -}}

{{- define "prometheus.sensorExporter.matchLabels" -}}
component: {{ .Values.sensorExporter.name | quote }}
{{ include "prometheus.common.matchLabels" . }}
{{- end -}}
...
{{/*
Create a fully qualified sensor-exporter name.
We truncate at 63 chars because some Kubernetes name fields are limited to this (by the DNS naming spec).
*/}}
{{- define "prometheus.sensorExporter.fullname" -}}
{{- if .Values.sensorExporter.fullnameOverride -}}
{{- .Values.sensorExporter.fullnameOverride | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- $name := default .Chart.Name .Values.nameOverride -}}
{{- if contains $name .Release.Name -}}
{{- printf "%s-%s" .Release.Name .Values.sensorExporter.name | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- printf "%s-%s-%s" .Release.Name $name .Values.sensorExporter.name | trunc 63 | trimSuffix "-" -}}
{{- end -}}
{{- end -}}
{{- end -}}
...
{{/*
Create the name of the service account to use for the sensorExporter component
*/}}
{{- define "prometheus.serviceAccountName.sensorExporter" -}}
{{- if .Values.serviceAccounts.sensorExporter.create -}}
    {{ default (include "prometheus.sensorExporter.fullname" .) .Values.serviceAccounts.sensorExporter.name }}
{{- else -}}
    {{ default "default" .Values.serviceAccounts.sensorExporter.name }}
{{- end -}}
{{- end -}}
